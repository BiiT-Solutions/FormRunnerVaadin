      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setSuperClass(com.biit.vaadin.client.popover.vcom.PopoverState.class, com.vaadin.shared.ui.window.WindowState.class);
            ...
            store.setClass("com.biit.vaadin.components.Popover", com.biit.vaadin.client.popover.vcom.PopoverConnector.class);
            store.setClass("com.biit.vaadin.components.Switch", com.biit.vaadin.client.vswitch.SwitchConnector.class);
            ...
            store.setConstructor(com.biit.vaadin.client.popover.VPopover.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.biit.vaadin.client.popover.VPopover.class);
              }
            });
            store.setConstructor(com.biit.vaadin.client.popover.vcom.PopoverConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.biit.vaadin.client.popover.vcom.PopoverConnector.class);
              }
            });
            store.setConstructor(com.biit.vaadin.client.popover.vcom.PopoverState.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.biit.vaadin.client.popover.vcom.PopoverState.class);
              }
            });
            store.setConstructor(com.biit.vaadin.client.vswitch.SwitchConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.biit.vaadin.client.vswitch.SwitchConnector.class);
              }
            });
          ...
          private void load1() {
            ...
            store.setReturnType(com.biit.vaadin.client.popover.vcom.PopoverConnector.class, "getWidget", new Type(com.biit.vaadin.client.popover.VPopover.class));
            store.setReturnType(com.biit.vaadin.client.popover.vcom.PopoverConnector.class, "getState", new Type(com.biit.vaadin.client.popover.vcom.PopoverState.class));
            store.setReturnType(com.biit.vaadin.client.vswitch.SwitchConnector.class, "getState", new Type(com.vaadin.shared.ui.checkbox.CheckBoxState.class));
          ...
          private void load2() {
            ...
            store.setParamTypes(com.biit.vaadin.client.popover.vcom.PopoverRpc.class, "close", new Type[] {});
            ...
            store.setProxyHandler(com.biit.vaadin.client.popover.vcom.PopoverRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new com.biit.vaadin.client.popover.vcom.PopoverRpc() {
                  public void close() {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.biit.vaadin.client.popover.vcom.PopoverRpc.class).getMethod("close"), new Object [] {});
                  }
                };
              }
            });
          ...
          private void load4() {
            ...
            store.setPropertyType(com.biit.vaadin.client.popover.vcom.PopoverState.class, "fullscreen", new Type(java.lang.Boolean.class));
            ...
            store.setPropertyType(com.biit.vaadin.client.popover.vcom.PopoverState.class, "relatedComponent", new Type(com.vaadin.shared.Connector.class));
          ...
          private void load5() {
            ...
            store.addOnStateChangeMethod(com.biit.vaadin.client.popover.vcom.PopoverConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.ui.AbstractComponentConnector.class, "handleContextClickListenerChange", new String[] {"registeredEventListeners", }));
            store.addOnStateChangeMethod(com.biit.vaadin.client.vswitch.SwitchConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.ui.AbstractComponentConnector.class, "handleContextClickListenerChange", new String[] {"registeredEventListeners", }));
          ...
          private native void loadNativeJs0(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.biit.vaadin.client.popover.vcom.PopoverState::setFullscreen(Z)(value.@java.lang.Boolean::booleanValue()());
              },
              getter: function(bean) {
                return @java.lang.Boolean::valueOf(Z)(bean.@com.biit.vaadin.client.popover.vcom.PopoverState::isFullscreen()());
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.biit.vaadin.client.popover.vcom.PopoverState::class, 'fullscreen', data);
          ...
          private native void loadNativeJs1(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.biit.vaadin.client.popover.vcom.PopoverState::setRelatedComponent(Lcom/vaadin/shared/Connector;)(value);
              },
              getter: function(bean) {
                return bean.@com.biit.vaadin.client.popover.vcom.PopoverState::getRelatedComponent()();
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.biit.vaadin.client.popover.vcom.PopoverState::class, 'relatedComponent', data);
